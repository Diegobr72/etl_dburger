...
-- Cria o banco de dados chamado dburgerdbstage0  
az sql db create -g cp3-dw -s kidelicia -n dburgerdbstage0 --service-objective Basic --backup-storage-redundancy Local --zone-redundant false
